...
{
	public void handleStatusCode(int statusCode, Object errorEntity) throws StatusCodeException;

	public void handleStatusCode(int statusCode, int expectedStatusCode, Object errorEntity) throws StatusCodeException;
